...
//             CurrentSemanticValue = new List<ClassDeclaration> { valueStack[0] };
//             break;
...
//             CurrentSemanticValue = valueStack[0].str;
//             break;
...
//             CurrentSemanticValue = valueStack[1].str;
//             break;
...
//                 valueStack[1].str,  // Identifier
//                 (List<ParameterDeclaration>)valueStack[2],
//                 valueStack[3].str   // Return type (nullable)
//             );
//             break;
...
//             CurrentSemanticValue = new IdentifierExpression(valueStack[0].str);
//             break;
