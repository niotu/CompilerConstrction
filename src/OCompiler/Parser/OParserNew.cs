...
// // GPPG version 1.5.3
// // DateTime: 16.10.2025 15:50:10
// // Input file <Grammar.y - 16.10.2025 15:50:08>
...
// #line 63 "Grammar.y"
//     { 
//         CurrentSemanticValue = new ProgramNode((List<ClassDeclaration>)ValueStack[ValueStack.Depth-2]); 
//     }
// #line default
//         break;
...
// #line 70 "Grammar.y"
//     { 
//         CurrentSemanticValue = new List<ClassDeclaration> { (ClassDeclaration)ValueStack[ValueStack.Depth-1] }; 
//     }
// #line default
//         break;
...
// #line 74 "Grammar.y"
//     { 
//         var list = (List<ClassDeclaration>)ValueStack[ValueStack.Depth-1];
//         list.Insert(0, (ClassDeclaration)ValueStack[ValueStack.Depth-2]);
...
// #line 83 "Grammar.y"
//     { 
//         CurrentSemanticValue = new ClassDeclaration((string)ValueStack[ValueStack.Depth-5], (string)ValueStack[ValueStack.Depth-4], (List<MemberDeclaration>)ValueStack[ValueStack.Depth-2]);
//     }
// #line default
//         break;
...
// #line 90 "Grammar.y"
//     {
//         CurrentSemanticValue = (string)ValueStack[ValueStack.Depth-2].str; 
//     }
// #line default
//         break;
...
// #line 101 "Grammar.y"
//     {
//         CurrentSemanticValue = (string)ValueStack[ValueStack.Depth-2];
//     }
// #line default
//         break;
...
// #line 112 "Grammar.y"
//     {
//         CurrentSemanticValue = (string)ValueStack[ValueStack.Depth-1].str;
//     }
// #line default
//         break;
...
// #line 119 "Grammar.y"
//     {
//         CurrentSemanticValue = new List<MemberDeclaration> { (MemberDeclaration)ValueStack[ValueStack.Depth-1] };
//     }
// #line default
//         break;
...
// #line 123 "Grammar.y"
//     {
//         var list = (List<MemberDeclaration>)ValueStack[ValueStack.Depth-1];
//         list.Insert(0, (MemberDeclaration)ValueStack[ValueStack.Depth-2]);
//         CurrentSemanticValue = list;
//     }
// #line default
//         break;
...
// #line 147 "Grammar.y"
//     {
//         CurrentSemanticValue = new VariableDeclaration((string)ValueStack[ValueStack.Depth-3].str, (ExpressionNode)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 154 "Grammar.y"
//     {
//         CurrentSemanticValue = new MethodDeclaration((MethodHeaderNode)ValueStack[ValueStack.Depth-2], (MethodBodyNode)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 172 "Grammar.y"
//     {
//         CurrentSemanticValue = new MethodHeaderNode((string)ValueStack[ValueStack.Depth-3].str, (List<ParameterDeclaration>)ValueStack[ValueStack.Depth-2], (string)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 219 "Grammar.y"
//     {
//         CurrentSemanticValue = new List<ParameterDeclaration>{ (ParameterDeclaration)ValueStack[ValueStack.Depth-1] };
//     }
// #line default
//         break;
...
// #line 223 "Grammar.y"
//     {
//         var list = (List<ParameterDeclaration>)ValueStack[ValueStack.Depth-1];
//         list.Insert(0, (ParameterDeclaration)ValueStack[ValueStack.Depth-3]);
//         CurrentSemanticValue = list;
//     }
// #line default
//         break;
...
// #line 232 "Grammar.y"
//     {
//         CurrentSemanticValue = new ParameterDeclaration((string)ValueStack[ValueStack.Depth-3].str, (string)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 239 "Grammar.y"
//     {
//         CurrentSemanticValue = new List<Statement>{ (Statement)ValueStack[ValueStack.Depth-1] };
//     }
// #line default
//         break;
...
// #line 250 "Grammar.y"
//     {
//         CurrentSemanticValue = new ConstructorDeclaration((List<ParameterDeclaration>)ValueStack[ValueStack.Depth-4], (List<Statement>)ValueStack[ValueStack.Depth-2]);
//     }
// #line default
//         break;
...
// #line 276 "Grammar.y"
//     {
//         CurrentSemanticValue = new Assignment((string)ValueStack[ValueStack.Depth-3].str, (ExpressionNode)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 283 "Grammar.y"
//     {
//         CurrentSemanticValue = new WhileLoop((ExpressionNode)ValueStack[ValueStack.Depth-4], (List<Statement>)ValueStack[ValueStack.Depth-2]);
//     }
// #line default
//         break;
...
// #line 290 "Grammar.y"
//     {
//         CurrentSemanticValue = new IfStatement((ExpressionNode)ValueStack[ValueStack.Depth-5], (List<Statement>)ValueStack[ValueStack.Depth-3], (ElsePart)ValueStack[ValueStack.Depth-2]);
//     }
// #line default
//         break;
...
// #line 301 "Grammar.y"
//     {
//         CurrentSemanticValue = new ElsePart((List<Statement>)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 308 "Grammar.y"
//     {
//         CurrentSemanticValue = new ReturnStatement((ExpressionNode)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 345 "Grammar.y"
//     {
//         CurrentSemanticValue = new ExpressionDotSequence(new List<ExpressionNode>{ (ExpressionNode)ValueStack[ValueStack.Depth-1] });
//     }
// #line default
//         break;
...
// #line 349 "Grammar.y"
//     {
//         var list = (ExpressionDotSequence)ValueStack[ValueStack.Depth-1];
//         list.Expressions.Insert(0, (ExpressionNode)ValueStack[ValueStack.Depth-3]);
//         CurrentSemanticValue = list;
//     }
// #line default
//         break;
...
// #line 358 "Grammar.y"
//     {
//         CurrentSemanticValue = new ConstructorInvocation((string)ValueStack[ValueStack.Depth-2], (List<ExpressionNode>)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 365 "Grammar.y"
//     {
//         CurrentSemanticValue = new FunctionalCall((ExpressionNode)ValueStack[ValueStack.Depth-2], (List<ExpressionNode>)ValueStack[ValueStack.Depth-1]);
//     }
// #line default
//         break;
...
// #line 387 "Grammar.y"
//     {
//         var list = (List<ExpressionNode>)ValueStack[ValueStack.Depth-1];
//         list.Insert(0, (ExpressionNode)ValueStack[ValueStack.Depth-3]);
//         CurrentSemanticValue = list;
//     }
// #line default
//         break;
...
// #line 396 "Grammar.y"
//     {
//         CurrentSemanticValue = new IntegerLiteral((int)ValueStack[ValueStack.Depth-1].integer);
//     }
// #line default
//         break;
...
// #line 400 "Grammar.y"
//     {
//         CurrentSemanticValue = new RealLiteral((double)ValueStack[ValueStack.Depth-1].real);
//     }
// #line default
//         break;
...
// #line 404 "Grammar.y"
//     {
//         CurrentSemanticValue = new BooleanLiteral((bool)ValueStack[ValueStack.Depth-1].boolean);
//     }
// #line default
//         break;
