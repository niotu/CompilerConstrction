...
namespace QUT.Gppg{
 ...
 where TSpan : IMerge<TSpan>, new() {
        ...
        public PushdownPrefixState<State> StateStack = new PushdownPrefixState<State>();
        public PushdownPrefixState<TValue> valueStack = new PushdownPrefixState<TValue>();
        public PushdownPrefixState<TSpan> locationStack = new PushdownPrefixState<TSpan>();
